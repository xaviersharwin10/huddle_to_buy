// check-balance.js — print ETH + MockUSDC balance for a Gensyn Testnet wallet
// Usage:
//   WALLET_ADDRESS=0x... PAY_TOKEN_ADDRESS=0x... node check-balance.js
//   PAY_TOKEN_ADDRESS=0x... node check-balance.js 0x...
...
if (!WALLET) {
  console.error("Usage: WALLET_ADDRESS=0x... PAY_TOKEN_ADDRESS=0x... node check-balance.js");
  console.error("   or: PAY_TOKEN_ADDRESS=0x... node check-balance.js <wallet-address>");
  process.exit(1);
}
if (!USDC) {
